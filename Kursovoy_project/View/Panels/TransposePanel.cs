...
{
    public partial class TransposePanel : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                double[,] ans = new double[mat1.table.GetLength(1), mat1.table.GetLength(0)];
                if (Parent is MainWindow)
                {
                    ans = ((MainWindow)Parent).controller.transpose(mat1.table);
                }

                DataMatrix mat2 = new DataMatrix(ans);
                Size s = new Size(mat1.Size.Height, mat1.Size.Width);
                mat2.Size = s;
